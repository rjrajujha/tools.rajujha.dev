      ...
      <div class="grid min-h-[min(70vh,720px)] gap-3 lg:h-[min(70vh,720px)] lg:grid-cols-2">
        <div class="flex min-h-64 flex-col overflow-hidden rounded-2xl border border-line bg-panel lg:min-h-0">
          <div class="border-b border-line bg-card/70 px-4 py-3">
            <label class="text-sm font-semibold text-ink" for="input">Editor</label>
          </div>
          <textarea id="input" class="min-h-0 w-full flex-1 resize-none border-0 bg-panel px-4 py-4 font-mono text-base leading-relaxed text-ink outline-none focus:ring-0 sm:text-sm" placeholder="# Hello&#10;&#10;Write **Markdown** here.&#10;&#10;- Fast&#10;- Local&#10;- Private" spellcheck="false"></textarea>
        </div>
        <div class="flex min-h-64 flex-col overflow-hidden rounded-2xl border border-line bg-card lg:min-h-0">
          <div class="border-b border-line bg-card/70 px-4 py-3">
