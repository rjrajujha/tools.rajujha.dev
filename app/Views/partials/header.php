  <header class="sticky top-0 z-20 border-b border-line/80 bg-soft/80 pt-[env(safe-area-inset-top)] backdrop-blur-md">
    <div class="mx-auto flex h-14 max-w-6xl items-center justify-between gap-3 px-4 sm:h-16 sm:px-5">
      ...
      <nav class="flex shrink-0 items-center gap-1 text-muted" aria-label="Primary">
        ...
        <button type="button" id="themeToggle" class="<?= $iconBtn ?>" aria-label="Switch to dark theme" aria-pressed="false">
          <svg class="theme-icon theme-icon-sun <?= $iconSvg ?>" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="4"/><path d="M12 3v2.2M12 18.8V21M4.9 4.9l1.6 1.6M17.5 17.5l1.6 1.6M3 12h2.2M18.8 12H21M4.9 19.1l1.6-1.6M17.5 6.5l1.6-1.6"/></svg>
          <svg class="theme-icon theme-icon-moon <?= $iconSvg ?>" viewBox="0 0 24 24" aria-hidden="true"><path d="M15.2 4.2a8 8 0 1 0 4.6 14.1 6.4 6.4 0 0 1-4.6-14.1z"/></svg>
        </button>
