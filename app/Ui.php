...
final class Ui
{
    ...
    {
        return [
            'field' => 'w-full min-w-0 rounded-xl border border-line bg-panel px-3.5 py-3 text-base text-ink outline-none transition placeholder:text-muted/70 focus:border-leaf/50 focus:ring-4 focus:ring-accent/25 sm:text-sm',
            'controlSelect' => 'h-11 min-h-11 w-full min-w-0 shrink-0 cursor-pointer touch-manipulation rounded-xl border border-line bg-panel py-2 pl-3 pr-9 text-base text-ink outline-none transition focus:border-leaf/50 focus:ring-4 focus:ring-accent/25 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm',
            ...
            'iconBtn' => 'inline-flex size-11 touch-manipulation items-center justify-center rounded-xl text-muted transition hover:bg-white hover:text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-leaf',
